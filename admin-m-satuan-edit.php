...
<?php
  ...
  $show = mysql_query("SELECT * FROM m_satuan WHERE id_satuan='$id_satuan'");
...
if(isset($_POST['simpan'])){
  ...
  if(mysql_num_rows($check) == 1){
     ...
     $update = mysql_query("UPDATE m_satuan SET nama_satuan='$nama_satuan' WHERE id_satuan='$id_satuan' ") or die(mysql_error());
  } 
            ...
            <form role="form" action="" method="post">
              <div class="box-body">
                <div class="form-group">
                    <input type="hidden" class="form-control" name="id_satuan" readonly value="<?php echo $d['id_satuan']; ?>" >
                    <label >Nama satuan </label>
                    <input type="text" class="form-control" name="nama_satuan" value="<?php echo $d['nama_satuan']; ?>" placeholder="Nama satuan">
                 </div>
              </div>
